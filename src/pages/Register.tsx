                ...
                <TabsContent key={type} value={type}>
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="space-y-2">
                      <Label htmlFor="name">
                        {type === "family" ? "Nome Famiglia" : 
                         type === "operator" ? "Nome e Cognome" : "Nome Organizzazione"}
                      </Label>
                      <div className="relative">
                        ...
                        <Input
                          id="name"
                          type="text"
                          placeholder={type === "family" ? "Es. Famiglia Rossi" : 
                                     type === "operator" ? "Mario Rossi" : "Nome della tua organizzazione"}
                          value={formData.name}
